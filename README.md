...
- Avoids revealing whether username or password was incorrect
- Demonstrates resource cleanup with try/catch/finally
...
*Example of input validation and protection against information disclosure.*
